...
test_find_by_token(Config) ->
  ...
  Passsword = <<"passsword">>,
  Email = <<"email">>,
  RegistedUser1 = cnf_user_repo:register(Name1, Passsword, Email),
  RegistedUser2 = cnf_user_repo:register(Name2, Passsword, Email),
  RegistedUser3 = cnf_user_repo:register(Name3, Passsword, Email),
